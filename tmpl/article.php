...
<header>
    ...
    <nav>
        <h2><a href="#">Explore this site</a></h2>

        <ul class="nav-site" id="nav-site">
...
<h1>From the BBC News Labs: Datastringer</h1>

<h2>Basile Simon walks through a project sparked at Hacks/Hackers London</h2>

<p>By <a href="#">Basile Simon</a>, <a href="#">Tiff Fehr</a>, <a href="#">Erin Kissane</a>, and <a href="#">Alyson Hurt</a></p>

<p>Posted on: 20 September 2015</p>
...
<ul>
    <li>
        <a href="#">
            <img src="/tmpl/img/fpo-article-teaser.jpg" alt="" /> How NPR Fact-Checks The Debate, Live
        </a>
    </li>
    <li>
        <a href="#">
            <img src="/tmpl/img/fpo-article-teaser.jpg" alt="" /> Event Round-Up, Oct 17
        </a>
    </li>
    <li>
        <a href="#">
            <img src="/tmpl/img/fpo-article-teaser.jpg" alt="" /> What I Learned from Researching Newsroom On-boarding and Off-Boarding Processes
        </a>
    </li>
</ul>
